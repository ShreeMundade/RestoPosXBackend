...
@InputType()
class CuisineUpdateManyWithoutRestaurantsInput {
  ...
  disconnect?: Array<CuisineWhereUniqueInput>;
  ...
  set?: Array<CuisineWhereUniqueInput>;
}
export { CuisineUpdateManyWithoutRestaurantsInput };
